...
public class DuplicateLead extends PreAndPost {
	...
	public void duplicateLead() throws InterruptedException {
		...
		type(locateElement("name", "emailAddress"), "san@hcl.com");
		...
		type(locateElement("id", "createLeadForm_firstName"), "Sankar");
		...
		click(locateElement("xpath", "//button[text()='Find Leads']"));
		Thread.sleep(2000);
		verifyExactText(locateElement("xpath", "//div[@class='x-grid3-cell-inner x-grid3-col-firstName']/a"), "Sankar");
